...
export function ToolResultBody({
  ...
  if (hidden === 0) return <pre className="whitespace-pre-wrap font-[inherit]">{body}</pre>
  ...
  return (
    ...
    >
      <pre className="whitespace-pre-wrap font-[inherit]">{expanded ? result.text : body}</pre>
