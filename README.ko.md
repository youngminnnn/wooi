...
- 🔍 **PR 리뷰도 이 안에서** — 에이전트에게 PR 을 맡기고, 지적을 다듬어 앱을 벗어나지 않고 게시합니다.
...
앱을 벗어나지 않고 PR 을 리뷰합니다. 리뷰는 사이드바에 자기 행을 갖고, 워크스페이스 하나를
...
- **지적은 diff 위에** — 각 지적이 해당하는 코드 줄에 정확히 붙습니다. 게시 전에 문장을 고치고,
  안 달 것은 버리고, 하나씩 또는 한꺼번에 올립니다.
